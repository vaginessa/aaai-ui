...
export const useLanguageStore = defineStore("i18n", () => {
    ...
    const HUDirectory:{[key: string]: string} = {
        ...
        "ratingtext6":" ennyi kudoszt kerestél ",
         ...
         "warning":"FIGYELEM!",
         "warningbadwords":" Egy olyan kérést készülsz küldeni, amelyet ki fog szűrni a Horda rendszere. Kérlek vizsgáld felül, vagy válassz egy olyan modellt ami nem NSFW.",
         "promptplaceholder":"Add meg a felszólítást itt",
         "llprompt":"Felszólítás",
         "lladdtrigger":"Addj hozzá ravaszt (dreambooth)",
         ...
         "intpredictnsfw":"gyerekek számára nem biztonságos.",
         "intpredictsfw":"gyerekek számára biztonságos.",
         "intcaption":"Felirat",
