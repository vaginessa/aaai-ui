            ...
            <div class="sidebar">
                <el-collapse v-model="uiStore.activeCollapse">
                    <el-collapse-item title="Generation Options" name="2">
                        ...
                        <form-slider label="Width"              prop="width"          v-model="store.params.width"              :min="workerStore.minWidth" :max="workerStore.maxWidth" :step="64"   :change="onDimensionsChange" />
                        <form-slider label="Height"             prop="height"         v-model="store.params.height"             :min="workerStore.minHeight" :max="workerStore.maxHeight" :step="64"   :change="onDimensionsChange" />
